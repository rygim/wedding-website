...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { can_attend: @rsvp.can_attend, confirmation_code: @rsvp.confirmation_code, name: @rsvp.name, num_attending: @rsvp.num_attending }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { can_attend: @rsvp.can_attend, confirmation_code: @rsvp.confirmation_code, name: @rsvp.name, num_attending: @rsvp.num_attending }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
